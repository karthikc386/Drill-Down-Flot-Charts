            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs" id="chart-tabs">
                <li class="active">          
                  <a href="#bar-chart-tab" data-toggle="tab" aria-expanded="false">
                    <i class="fa fa-bar-chart" aria-hidden="true"></i> Bar Chart
                  </a>
                </li>
              ...
              <div class="tab-content"> 
                <div class="tab-pane active" id="bar-chart-tab">
                  ...
                  @else
                  <p id="bar_chart_bck_btn" style="display:none" class="pull-right"><a href="#"  class="btn btn-block btn-default btn-flat"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Back to Chart-1</a></p>
                  <div class="clearfix"></div>
                  <div id="bar-chart" style="width: 100%;height:300px;padding: 0px; position: relative;">
                  </div>  
                  @endif          
                </div>
              </div>
...
<script src="{{ asset('js/custom-bar-chart.js') }}" type="text/javascript"></script> 
